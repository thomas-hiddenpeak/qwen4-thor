...
最新完成：四分支layer1输入投影与短卷积，原分支全部恢复，
短卷积输出同GDN捕获输入、历史同原更新。输入/中间/双项修正
卷积输出改变9323498/18034465/22371185个BF16，影响3362/
4027/4087 token，均在因果支持集。尚未做GDN归一化/门值/递推。
...
1. 四分支已过layer1投影/短卷积；重算q/k norm、A/B变换及
   GDN递推，先恢复原支，再接NormGate/输出、HC写回及MoE。
