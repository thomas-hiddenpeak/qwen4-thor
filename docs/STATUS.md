...
下一步验证保持逐行算术顺序的批量 BF16 投影，仍以 HTTP 首测，
同时保留共享权重读取的性能目标；不把逐行重复读权重当最终优化。
当前诊断二进制 SHA-256：
`459f86be510b44bba0bf25125c0ba9d164461a81a59536c3595903bfbb356810`。
新增 D2H/同步不用于性能结论；本候选仍未接受。
