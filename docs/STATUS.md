...
- **发现E4M3编码边界错误，隔离候选a984c284待验收。** 旧转换将
  精确256编码成448，次正规舍入/进位也不符合约定；仅由源码推导，
  尚未证明关联4K错题。只改format.h，构建0且零警告，首项固定
  质量HTTP已完成11/11且全文同正式，服务0；原冻结独立15题已
  启动（会话75292）。父版2392f6b1已归档，运行时未接受或提交，
  完整五档和低层测试未运行。详见[编码审查](E4M3_ROUNDING_2026-09-23.md)。
