...
最新完成：重复证据共享释放约4.67GB，原25份清单17836项复核；
随后四支layer2短卷积及历史完成，原支全部恢复。三修正支输出
差异36286216/36939248/37217600项BF16，影响4079/4094/4094
位置。终点GDN原始QKV，归一化/门值/状态递推尚未计算。
...
1. 四分支已到layer2卷积/GDN原始QKV；接自身qk norm、A/B门值
   和状态递推，再做NormGate/输出与MoE；继续保留20GiB余量。
