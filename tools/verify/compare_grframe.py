"""Compare actual GRFrame and baseline HC paths only after full HTTP gates."""
import argparse
import hashlib
import json
...
def main():
    ...
    for source in SOURCES:
        if (ROOT / source).read_bytes() != (run / Path(source).name).read_bytes():
